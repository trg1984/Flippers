                ...
                */
                Flippers.prototype.initialize = function(place, config) {
                    ...
                    for (var i = 0; i < self.config.items.length; ++i) {
                        styles += 
                            ".flippers .cover" + i + " {" + 
                                "background-image: url('" + (typeof(self.config.items[i]['frontCover']) === 'string' ? self.config.items[i].frontCover : self.config.defaultCover) + "') !important;" + 
                            "}\n";
                    }
                    ...
                    for (var i = -self.config.extraCount; i <= self.config.extraCount; ++i) {
                        this.place.append(
                            '<div class="inline page ' + ( 'onSide' + i ) + '" data-item="' + item + '">' +
                                ...
                                //'<div class="back cover flipped"></div>' +
                            '</div>'
                        );
                        ++item;
                ...
                Flippers.prototype.moveLeft = function() {
                    ...
                    rightSeam.find('.cover').removeClass('cover' + rightSeamItem).addClass('cover' + newItem);
                }
                ...
                Flippers.prototype.moveRight = function() {
                    ...
                    leftSeam.find('.cover').removeClass('cover' + leftSeamItem).addClass('cover' + newItem);
                }
                ...
                Flippers.prototype.select = function() {
                    ...
                    console.log('Selected item ' + selected + ': ', self.config.items[selected].title);
                }
            }
        { // jQuery Plugin
            var methods = {
